...
def main():
    ...
    parser.add_argument("--lr_scheduler", type=int, required=False, default=0)
    parser.add_argument(
        "--scheduler_mode",
        type=str,
        required=False,
    ...
    parser.add_argument(
        ...
        required=False,
        default=0,
        help="If set to 0 early stopping is deactivated.",
    )
    parser.add_argument(
        "--early_stopping_min_delta", type=float, required=False, default=0
    )
    ...
    parser.add_argument(
        "--activation_for_final_decoder_layer", type=int, required=False, default=0
    )
    parser.add_argument(
    ...
    m_config = {}
    m_config["hidden_layers"] = ast.literal_eval(args.hidden_layer_representation)
    m_config["activation_for_code_layer"] = args.activation_for_code_layer == 1
    m_config["activation_for_final_decoder_layer"] = (
        args.activation_for_final_decoder_layer == 1
    )
