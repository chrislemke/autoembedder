...
| model_title                        | str   | False    | autoembedder.bin |                                                                                                                                                                                          |
| model_save_path                    | str   | False    |                  |                                                                                                                                                                                          |
| n_save_checkpoints                 | int   | False    |                  |                                                                                                                                                                                          |
| lr_scheduler                       | str   | False    | min              | `min` or `max`                                                                                                                                                                           |
| scheduler_patience                 | int   | False    | 2                | If set to 0 early stopping is deactivated.                                                                                                                                               |
| early_stopping_min_delta           | float | False    | 0                |                                                                                                                                                                                          |
